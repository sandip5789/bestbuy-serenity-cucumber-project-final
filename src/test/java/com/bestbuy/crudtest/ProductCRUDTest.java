...
public class ProductCRUDTest extends TestBase {
    static String name = "Bakery Soft" + getRandomValue();
    static String type = "Cakes and Muffins";
    static String upc = "98765" + getRandomValue();
    static double price = 2.98;
    static String description = "This is a placeholder request for creating a new product";
    static String model = "pqr" + getRandomValue();
